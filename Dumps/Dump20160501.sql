CREATE DATABASE  IF NOT EXISTS `petlove` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `petlove`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: localhost    Database: petlove
-- ------------------------------------------------------
...
CREATE TABLE `tb_animal` (
  ...
  PRIMARY KEY (`IDAnimal`,`IDUsuario`,`IDRaca`),
  KEY `fk_tb_animal_tb_usuario1_idx` (`IDUsuario`),
  KEY `fk_tb_animal_tb_racas1_idx` (`IDRaca`),
  CONSTRAINT `fk_tb_animal_tb_usuario1` FOREIGN KEY (`IDUsuario`) REFERENCES `tb_usuario` (`IDUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_animal_tb_racas1` FOREIGN KEY (`IDRaca`) REFERENCES `tb_racas` (`IDRaca`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_favoritos` (
  ...
  `IDAnimalFavorito` int(11) NOT NULL,
  PRIMARY KEY (`IDUsuario`),
  KEY `fk_tb_usuario_has_tb_animal_tb_usuario_idx` (`IDUsuario`),
  KEY `fk_tb_favoritos_tb_animal1_idx` (`IDAnimalFavorito`),
  CONSTRAINT `fk_tb_usuario_has_tb_animal_tb_usuario` FOREIGN KEY (`IDUsuario`) REFERENCES `tb_usuario` (`IDUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_favoritos_tb_animal1` FOREIGN KEY (`IDAnimalFavorito`) REFERENCES `tb_animal` (`IDAnimal`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_fotos` (
  ...
  PRIMARY KEY (`IDFoto`),
  KEY `fk_tb_fotos_tb_animal1_idx` (`IDAnimal`),
  CONSTRAINT `fk_tb_fotos_tb_animal1` FOREIGN KEY (`IDAnimal`) REFERENCES `tb_animal` (`IDAnimal`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-01  8:34:14
